...
* [cite_start]**Data Generation (Python)**: Custom scripts created to maintain relational integrity across customers, trades, and holdings. [cite: 6, 160]
* [cite_start]**Relational Storage**: Structured data stored in optimized CSV files for high-performance BI modeling. [cite: 1, 2, 6]
* [cite_start]**BI Layer (Power BI)**: An interactive multi-page dashboard designed for Executive and Branch-level decision-making. [cite: 22, 75]
...
* [cite_start]**Relational Synchronization**: Every `portfolio_value` in the holdings table is logically consistent with the historical Buy/Sell transactions for that customer. [cite: 6, 161]
* [cite_start]**Automated Brokerage Logic**: Simulated revenue model by calculating a 0.5% brokerage fee for Equity transactions, allowing for profitability analysis. [cite: 1, 82]
* [cite_start]**RFM Scoring Engine**: An innovative segmentation model that scores clients on Recency, Frequency, and Monetary value to drive targeted marketing. [cite: 25, 151]
* [cite_start]**Spatial Wealth Analysis**: AUM mapping across major South Indian hubs including Thiruvananthapuram, Kochi, Coimbatore, and Bengaluru. [cite: 21, 30]
...
* [cite_start]**`powerbi.pdf`**: The full multi-page visual report export. [cite: 22]
